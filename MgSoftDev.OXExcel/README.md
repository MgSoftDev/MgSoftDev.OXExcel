...
- **Gestion de Memoria**: Implementa IDisposable para limpieza de recursos
...
t.TableType(OxTableType.Skeleton);  // Solo estructura
```
...
La libreria esta optimizada para manejar grandes volumenes de datos:
